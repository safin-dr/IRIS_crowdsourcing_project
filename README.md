...
Код призван решить проблему crowdcourcing разметки датасета с фотографиями хвойных / не хвойных деревьев и дальнейшем обучении на размеченном датасете модели бинарной классификации. В этом репозитории находится код для препроцессинга данных при помощи ResNet-like эмбеддингов модели и подготовки самой human-in-loop разметки, а также код для обучения модели бинарной классификации и генерации финальных предсказаний.
...
- собрали итоговый датасет из ground-truth, размеченных толокерами и ранее достоверно классифицированных картинок (псевдолейблинг);
